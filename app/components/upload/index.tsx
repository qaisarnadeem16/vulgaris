            ...
            <div className="p-4 space-y-4">
              ...
              <div className="flex items-center max-w-md mx-auto rounded-full py-1 border border-[#52469E] space-x-4 px-2">
                ...
                <button
                  ...
                  className="bg-red-600 text-white px-6 py-1 rounded-full shadow-md hover:bg-red-700 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 transition duration-200"
                >
                  Upload
                </button>
              </div>
